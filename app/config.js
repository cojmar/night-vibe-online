...
const FALLBACK_DEFAULTS = {
  ...
  ENEMY_SPEED_SCALE_LVL_MULT: 0.875,
...
export const FALLBACK_CLASS_DATA = {
  ...
  magicgladiator: { name: 'Magic Gladiator', icon: '✨', hp: 140, mp: 80, atk: 26, spd: 6, color: '#8e44ad', accent: '#9b59b6', s1Name: 'Psionic Slash', s1Color: '#e74c3c', s2Name: 'Cross Slash', s2Color: '#ffd700', s2SpiritColor: '#9b4dff', bodyType: 'magicgladiator' }
};
...
export const FALLBACK_ITEMS_DB = [
  ...
  { name: 'Leather Vest', icon: '🛡️', gearType: 'Armor', rarity: 'normal', color: '#ecf0f1', stats: { atk: 0, maxHp: 8, spd: 0 } },
  { name: 'Bronze Ring', icon: '💍', gearType: 'Ring', rarity: 'normal', color: '#ecf0f1', stats: { atk: 0, maxHp: 0, spd: 1.5 } },
  { name: 'Simple Talisman', icon: '📿', gearType: 'Amulet', rarity: 'normal', color: '#ecf0f1', stats: { atk: 0, maxHp: 5, spd: 0 } },

  // Magic Rarity (Blue, 2 attributes)
  { name: 'Gleaming Broadsword', icon: '🗡️', gearType: 'Weapon', rarity: 'magic', color: '#3498db', stats: { atk: 12, maxHp: 5, spd: 0 } },
  { name: 'Reinforced Chainmail', icon: '🛡️', gearType: 'Armor', rarity: 'magic', color: '#3498db', stats: { atk: 0, maxHp: 15, spd: 1.0 } },
  { name: 'Chrono Ring', icon: '💍', gearType: 'Ring', rarity: 'magic', color: '#3498db', stats: { atk: 4, maxHp: 0, spd: 2.5 } },
  { name: 'Empowered Necklace', icon: '📿', gearType: 'Amulet', rarity: 'magic', color: '#3498db', stats: { atk: 5, maxHp: 10, spd: 0 } },

  // Rare Rarity (Yellow, 3 attributes)
  { name: 'Heavenly Excalibur', icon: '🗡️', gearType: 'Weapon', rarity: 'rare', color: '#f1c40f', stats: { atk: 20, maxHp: 12, spd: 2.0 } },
  { name: 'Valorous Aegis Plate', icon: '🛡️', gearType: 'Armor', rarity: 'rare', color: '#f1c40f', stats: { atk: 8, maxHp: 30, spd: 2.5 } },
  { name: 'Celestial Loop', icon: '💍', gearType: 'Ring', rarity: 'rare', color: '#f1c40f', stats: { atk: 10, maxHp: 6, spd: 4.0 } },
  { name: 'Relic of the Dragon', icon: '📿', gearType: 'Amulet', rarity: 'rare', color: '#f1c40f', stats: { atk: 12, maxHp: 22, spd: 1.8 } }
];
...
export const ENV_CONFIG = {
  forest: { skyTop: '#0a1628', skyMid: '#1a3a2a', skyBot: '#153020', ground: '#09150e', groundY: 0.52, horizonType: 'trees', horizonColor: '#0b1911', groundType: 'grass', groundColor: '#1e4024' },
  castle: { skyTop: '#2a2a3a', skyMid: '#3a3a4a', skyBot: '#353545', ground: '#151520', groundY: 0.50, horizonType: 'walls', horizonColor: '#111116', groundType: 'stones', groundColor: '#2f3542' },
  volcano: { skyTop: '#2a0a0a', skyMid: '#4a1a0a', skyBot: '#301515', ground: '#120505', groundY: 0.55, horizonType: 'mountains', horizonColor: '#1f0a0a', groundType: 'cracks', groundColor: '#e74c3c' },
  beach: { skyTop: '#1a3a6a', skyMid: '#3a7aaa', skyBot: '#6aaada', ground: '#c49564', groundY: 0.51, horizonType: 'palms', horizonColor: '#1d441d', groundType: 'shells', groundColor: '#f5b041' },
  tundra: { skyTop: '#0a1a3a', skyMid: '#1a3a6a', skyBot: '#f0f5fa', ground: '#b0c8d8', groundY: 0.56, horizonType: 'pines', horizonColor: '#748a9c', groundType: 'ice', groundColor: '#ffffff' },
  swamp: { skyTop: '#0a1a0a', skyMid: '#1a2a1a', skyBot: '#152515', ground: '#101a10', groundY: 0.48, horizonType: 'deadtrees', horizonColor: '#081108', groundType: 'mud', groundColor: '#3e4a34' }
};
